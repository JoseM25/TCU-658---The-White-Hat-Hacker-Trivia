...
class ManageQuestionsScreen:
    ...
    def build_content(self):
        ...
        sidebar = ctk.CTkFrame(content, fg_color="transparent")
        sidebar.grid(row=0, column=0, sticky="ns", padx=(32, 24), pady=32)
        ...
        placeholder.grid(row=0, column=1, sticky="nsew", padx=(0, 32), pady=32)
